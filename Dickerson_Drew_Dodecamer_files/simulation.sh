...
pmemd.cuda -O -i heat.in -o heat.out -p dna.top -c min.ncrst -r heat.ncrst -x heat.nc -inf heat.mdinfo -ref dna.crd

pmemd.cuda -O -i equil.in -o equil.out -p dna.top -c heat.ncrst -r equil.ncrst -x equil.nc -inf equil.mdinfo
